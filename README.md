...
In case you have any issue reproducing, is probably that you have some value setted to window.localStorage.data, you can fix it running window.localStorage.clear() in your browser console and refresh the page, this will fix the issue.
